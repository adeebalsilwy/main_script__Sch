        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'saas' || $main_menu == 'saas_setting') echo 'nav-expanded nav-active';?>">
                        <a>
                    ...
                    if (is_admin_loggedin() && $saasExisting):
                        ?>
                    <!-- School Subscription (SaaS)  -->
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'qr_attendance' || $main_menu == 'qr_attendance_report') echo 'nav-expanded nav-active';?>">
                        <a>
                            <i class="icons icon-chart"></i><span><?=translate('qr_code') . " " . translate('attendance')?></span>
                        </a>
                        <ul class="nav nav-children">
